...
call C:\Keil_v5\ARM\ARM_Compiler_5.06u7\bin\fromelf.exe --vhx --32x1 --output bram_a7.hex objects\CW305_DesignStart.axf
...
call C:\Keil_v5\ARM\ARM_Compiler_5.06u7\bin\fromelf.exe --vhx --8x1  --output qspi_a7.hex objects\CW305_DesignStart.axf
@REM - Files to load onto DAPLink QSPI board
call C:\Keil_v5\ARM\ARM_Compiler_5.06u7\bin\fromelf.exe  --bin        --output qspi_a7.bin objects\CW305_DesignStart.axf

@REM - Copy the files to the relevant directories of the hardware project
copy .\bram_a7.elf ..\..\..\hardware\pv_CW305_DesignStart
copy .\bram_a7.hex ..\..\..\hardware\pv_CW305_DesignStart
