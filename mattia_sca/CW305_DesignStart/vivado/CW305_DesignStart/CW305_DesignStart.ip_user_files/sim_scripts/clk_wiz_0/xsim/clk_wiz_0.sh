...
#
# Generated by Vivado on Tue Nov 28 16:13:24 CET 2023
...
simulate()
{
  xsim clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/m3_for_arty_a7.protoinst" -log simulate.log
}
