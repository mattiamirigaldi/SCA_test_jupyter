...
create_clock -period 100.000 -name pll_clk1 -waveform {0.000 10.000} [get_nets pll_clk1]
create_clock -period 100.000 -name tio_clkin -waveform {0.000 10.000} [get_nets tio_clkin]
create_clock -period 100.000 -name swclk -waveform {0.000 10.000} [get_nets swclk]
...
#create_generated_clock -name cpu_clk -source [get_pins U_clk_select/clk_wiz_0/inst/clkout1_buf/I0]
#create_generated_clock -name cpu_clk [get_clocks clk_out1_clk_wiz_0]
...
#set_property DRIVE 8 [get_ports led7]
...
#set_property PACKAGE_PIN T8 [get_ports led7]
...
#set_output_delay  -clock [get_clocks slow_out_clk] -add_delay $untimed_id [get_ports led7]
