...
proc create_hier_cell_Clocks_and_Resets { parentCell nameHier } {
  ...
  connect_bd_net -net locked_i_1 [get_bd_pins locked_i] [get_bd_pins proc_sys_reset_base/dcm_locked]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net locked_1 [get_bd_ports locked] [get_bd_pins Clocks_and_Resets/locked_i]
  ...
  connect_bd_net -net xlconstant_4_dout [get_bd_pins xlconcat_0/In4] [get_bd_pins xlconstant_4/dout]
