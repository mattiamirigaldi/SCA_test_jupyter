...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set CFGITCMEN [ create_bd_port -dir I -from 1 -to 0 CFGITCMEN ]
  set JTAGNSW [ create_bd_port -dir O JTAGNSW ]
  set JTAGTOP [ create_bd_port -dir O JTAGTOP ]
  set M3_RESET_OUT [ create_bd_port -dir O -from 0 -to 0 -type data M3_RESET_OUT ]
  set SWCLK [ create_bd_port -dir I -type clk SWCLK ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {20000000} \
 ] $SWCLK
  set SWDI [ create_bd_port -dir I -type data SWDI ]
  set SWDO [ create_bd_port -dir O SWDO ]
  set SWDOEN [ create_bd_port -dir O SWDOEN ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_S_AXI_ACLK_FREQ_HZ_d {20.0} \
  ...
  connect_bd_net -net xlconstant_3_dout [get_bd_pins xlconcat_0/In7] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_pins xlconcat_0/In6] [get_bd_pins xlconstant_4/dout]
  connect_bd_net -net xlconstant_5_dout [get_bd_pins xlconcat_0/In5] [get_bd_pins xlconstant_5/dout]
  connect_bd_net -net xlconstant_6_dout [get_bd_pins xlconcat_0/In4] [get_bd_pins xlconstant_6/dout]
  connect_bd_net -net xlconstant_7_dout [get_bd_pins xlconcat_0/In3] [get_bd_pins xlconstant_7/dout]
